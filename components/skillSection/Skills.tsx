  ...
  return (
    <section className="w-full px-4 sm:px-8 py-12 sm:py-16 text-center sm:text-left">
      ...
      <div className="mb-10 sm:mb-12 space-y-4">
        <h2 className="text-[48px] sm:text-[72px] lg:text-[96px] font-bold text-white/35 tracking-[0.2em] uppercase leading-none">
          My Arsenal
        </h2>
        <p className="text-base sm:text-lg md:text-xl lg:text-2xl font-extralight text-white max-w-3xl mx-auto sm:mx-0">
